...
//    echo $form->field($model, 'worker_birth')->textInput();
    ...
    <div class="mydatepicker">
        ...
        echo DatePicker::widget([
            ...
            'options' => [
//                'placeholder' => Yii::t('foreign_workers', 'Enter contract date ...'),
                'class' => 'mydatepicker comon',
            ],
            'pluginOptions' => [
                'autoclose' => true,
...
//    echo $form->field($model, 'field')->textInput(['maxlength' => true]);
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? Yii::t('foreign_workers', 'Create') : Yii::t('foreign_workers', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
