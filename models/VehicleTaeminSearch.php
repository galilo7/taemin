...
class VehicleTaeminSearch extends AppVehicleTaemin {
    ...
    public function mySearch($params, $customerId) {
        $query = (new \yii\db\Query())
                ->select(["CONCAT('vehicle-taemin+', vehicle_taemin.id) AS id", 'vehicle_taemin.r_customer', 'vehicle_taemin.r_available_taemin', 'vehicle_taemin.code', 'vehicle_taemin.madmoun_name', 'vehicle_taemin.remaining', 'vehicle_taemin.updated_at', "CONCAT(customers.first_name, customers.fathers_name, customers.last_name) AS fullName", 'customers.first_name', 'customers.fathers_name', 'customers.last_name', 'available_taemin.name AS taemin_name'])
                ->from('vehicle_taemin')
                ->join('LEFT JOIN', 'customers', 'customers.id = vehicle_taemin.r_customer')
                ->join('LEFT JOIN', 'available_taemin', 'available_taemin.id = vehicle_taemin.r_available_taemin');
